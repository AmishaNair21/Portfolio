  ...
  return (
    <div>
      ...
      <audio
        ref={audioRef}
        loop
        src="/Adventure.mp3" // Add your music file in the public folder
      />
      ...
      <div className="flex flex-col justify-center items-center">
        <div className="flex flex-col items-center w-full h-screen">
          <h1 className="text-center text-6xl 2xl:text-9xl drop-shadow-md md:mt-20 mt-10 2xl:mt-56 2xl:drop-shadow-xl text-[#FFE5E5] hero-heading font-bold">
          ...
          <div className="w-2/3 md:w-1/2 md:h-40 rounded-md border-b-8 border-r-8 border-l-2 border-t-2 border-[#5F4793] 2xl:h-72 2xl:mt-10 bg-[#8165C0]">
            ...
            <p className="p-5 2xl:text-4xl 2xl:p-10">
              Myself <span style={{ color: '#FFB0B0' }}>Amisha Nair</span>, an
